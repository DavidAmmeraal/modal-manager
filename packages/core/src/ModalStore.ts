...
export class ModalsStore {
  ...
  #listeners: Map<ModalKey, Set<() => void>> = new Map()
  #openModal: ModalKey | undefined
  ...
  /**
   * Closes any open modal, if one exists.
   * @returns
   */
  closeAnyOpen = () => {
    if (!this.#openModal) return Promise.resolve()
    return this.close(this.#openModal)
  }
